...
function Firstchoice() {
  return (
    <div className='bg-[#1D332D] flex p-14 xl:p-20 2xl:p-28 xl:px-32 2xl:px-32  justify-between font-poppins'>
      ...
      <div className='flex flex-col justify-between gap-0 2xl:gap-32 '>
        ...
        <div className='text-nowrap'>
          <p className='text-[30px] xl:text-[40px] text-white font-playfair'>Your first choice in</p>
          <p className='text-[30px] xl:text-[40px] text-[#B3BAAA]'>PRIVATE LENDING</p>
        </div>
      </div>
      
      <div className='lg:text-[18px] xl:text-[20px] 2xl:text-[18px] md:pl-20 lg:pl-24 xl:pl-36 2xl:pl-60'>
